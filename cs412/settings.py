...
SECRET_KEY = 'django-insecure-z05yi*hiej!$#u0lz!6ixx359u-_!s!-@7&6xce5o7drz#qge1'
...
INSTALLED_APPS = [
    ...
    'hw', #module 1 examples
    'quotes', # Assignment 1
    'formdata', #module 2 examples
    'restaurant', #Assignment 2
    'blog', # module 3,4,5,6 examples
    'mini_insta', #Assignment 3,4,5,6
    'marathon_analytics', #module 7 examples
...
if socket.gethostname() == CS_DEPLOYMENT_HOSTNAME:
    STATIC_URL = '/ljbrown4/static/'
    MEDIA_URL = '/ljbrown4/media/'
